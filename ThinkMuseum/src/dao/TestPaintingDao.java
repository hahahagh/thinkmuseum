...
public class TestPaintingDao extends TestCase{
	
	private static TestPaintingDao instance = new TestPaintingDao();
	
	private TestPaintingDao() {}
		
	public static TestPaintingDao getInstance() {
		return instance;
	}
